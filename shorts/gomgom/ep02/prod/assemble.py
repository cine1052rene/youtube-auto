# -*- coding: utf-8 -*-
"""
곰곰한 마음 2화 조립 (13컷 전부 영상 + Luna 내레이션 + 고운돋움 자막 + 선택적 배경음악)
사용: python assemble.py
입력: v3/clips/NN.mp4, ep01/audio/luna/NN.mp3, ep01/lines.json(narrator), v3/bgm.mp3(있으면)
출력: v3/out/ep02.mp4 (1080x1920), v3/out/ep02_preview.mp4 (540x960), v3/out/timeline.json
