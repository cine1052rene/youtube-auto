...
CUTS = [
    ...
    ("e1_04", "1화", "04", "소파에서 하품",
     ...
     None),
    ("e1_05", "1화", "05", "빛구슬 사이의 콩이",
     "콩이만 날아야 하는데 곰곰이가 떠올라 뒤집히며 모양이 뭉개짐",
     "곰곰이는 러그에 앉은 채 올려다보기만 하고, 빛구슬 사이를 나는 건 콩이뿐",
     None),
    ("e1_10", "1화", "10", "머리 위에 내려앉는 콩이",
     "입을 벌리는 순간 얼굴 비율이 달라져 다른 곰처럼 보임",
     "콩이가 날아와 머리에 앉는 동안 곰곰이는 입 다문 미소로 올려다봄",
     "Wan → Seedance"),
...
<section>
  ...
  <h1>입을 다문 곰곰이로 다시 찍은 6컷</h1>
  <p class="lead">3화 때 정한 "곰곰이는 항상 입 다문 미소" 규칙을 1·2화에도 맞췄습니다. 왼쪽이 이전 컷, 오른쪽이 바뀐 컷입니다. 두 영상은 자동으로 반복되고, 버튼을 누르면 둘 다 처음부터 같이 시작합니다.</p>
...
<section class="foot">
  ...
  <p class="soft">1화 10·13의 새 컷은 8초짜리라, 조립할 때는 대사 길이에 맞는 구간만 씁니다. 보정에 쓴 크레딧 약 21 · 잔액 1010</p>
</section>
</div>
<script>
